...
public class VentanaConsultaPaquetes extends JDialog{
    ...
    private String titulos[] = {"Tipo Paquete", "Peso", "Largo", "Ancho", "Alto", "Volumen","Tipo Repartidor", "Codigo Postal"};
    ...
    public void actualizarTabla() {
        ...
        try {
            ...
            for (RegistroPaquetes rd : lista) {
                String fila[] = {rd.getTipoPaquete(), String.valueOf(rd.getPesop()), String.valueOf(rd.getLargo()), String.valueOf(rd.getAncho()),String.valueOf(rd.getAlto()), rd.getVolumen(),rd.getTRepartidor(),String.valueOf(rd.getCodPostal())};
                if (filtro != null) {
